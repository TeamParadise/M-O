...
public class RobotMap
{
	...
	public static final int toteLifterPistonHighIn		= 2; //high pressure lifting controller
	public static final int toteLifterPistonHighOut		= 3;
	public static final int toteLifterLowPressureAir 		= 4; //second controller for lowering lifter piston with lower PSI
	public static final int toteLifterHighPressureAir 		= 5;
	// USB Camera Name
